    ...
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      <Tabs value={period} onValueChange={(v) => setPeriod(v as TimePeriod)} className="space-y-6">
        <TabsList className="grid w-full max-w-md grid-cols-4 h-11">
          ...
          <TabsTrigger value="week" className="text-sm">7 Days</TabsTrigger>
          <TabsTrigger value="month" className="text-sm">30 Days</TabsTrigger>
            ...
            <>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">{formatCurrency(summary.averageOrderValue)}</div>
                    <p className="text-xs text-muted-foreground mt-1">
                      Per completed order
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">{summary.cancellationRate.toFixed(1)}%</div>
                    <p className="text-xs text-muted-foreground mt-1">
