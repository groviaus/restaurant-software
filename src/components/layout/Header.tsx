...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className=" flex h-24 sm:h-16 items-center justify-between border-b bg-white px-3 sm:px-4 lg:px-6 safe-area-top">
      ...
      <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
        ...
        {profile && (
          <span className="hidden xs:inline-flex rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-800">
            {profile.role}
          </span>
        )}
